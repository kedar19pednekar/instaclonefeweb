...
class Post extends Component {
    ...
    getComments=()=>{ //API backend
        ...
        fetch('https://kedarinstaclonebe.herokuapp.com/comments/'+this.props.id)
    ...
    submitComments =(event) =>{
        if(event.key === "Enter") {
            ...
            if(comment!== null || comment!== undefined) {
                ...
                fetch("https://kedarinstaclonebe.herokuapp.com/comments",requestOptions)
                .then(response => response.json())
                .then(data => {
                    this.getComments();
                })
    ...
    render() { 
        ...
        <div className="post__container">
          ...
          {/* Image */}
          <div>
              <img src={this.props.postImage}  height="300px "width="615px" /> 
          </div>

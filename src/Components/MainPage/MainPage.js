...
class MainPage extends Component {
    ...
    getPost=()=>{ //API
        ...
        fetch('https://kedarinstaclonebe.herokuapp.com/post')
        ...
        uploadTask.on(
          ...
          function () {
            uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                ...
                fetch("https://kedarinstaclonebe.herokuapp.com/post",requestOptions)
                .then(response => response.json())
                .then(data => {
                    console.log(data);
                    thisContext.getPost();
    ...
    render() { 
        return ( 
            <div>
                ...
                <div  id="scroller" className='implementing_fullwin_scroll'>
                {
